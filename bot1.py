...
# ==========================================
# 🛡️ سحب المفتاح من الخزنة السرية (Secrets)
# ==========================================
try:
    # الكود ده بيدور على المفتاح في إعدادات الموقع اللي لسه عاملاها
    my_secret_key = st.secrets["GOOGLE_API_KEY"]
except:
    st.error("⛔ لم يتم العثور على المفتاح في Secrets. تأكدي من الخطوة 1.")
    st.stop()
